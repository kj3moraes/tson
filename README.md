# tson
`tson` is JSON editor library written in Go. This repository is forked from the original repository given here - [skanehira/tson](https://github.com/skanehira/tson). This tool displays JSON as a tree and you can search and edit key or values.
